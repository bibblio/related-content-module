...
```html
<amp-iframe width="1" height="1" layout="responsive" sandbox="allow-scripts allow-popups" src="https://cdn.bibblio.org/rcm/3.10/amp.html?recommendationKey=YOUR_RECOMMENDATION_KEY&contentItemId=YOUR_CONTENT_ITEM_ID">
...
```html
<amp-iframe width="1" height="1" layout="responsive" sandbox="allow-scripts allow-popups" src="https://cdn.bibblio.org/rcm/3.10/amp.html?recommendationKey=YOUR_RECOMMENDATION_KEY&contentItemId=YOUR_CONTENT_ITEM_ID&utm_source=Bibblio&utm_campaign=related&styleClasses=bib--row-3,bib--hover">
    <amp-img layout="fill" src="" placeholder></amp-img>
</amp-iframe>
```
